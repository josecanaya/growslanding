export const esStorytelling = {
  ...
  cta: {
    title: "¿Listo para transformar tu obra?",
    description: "Únete a la revolución digital de la construcción. Descubre cómo GROWS puede optimizar tu próximo proyecto.",
    button: "Probar GROWS"
  }
};
