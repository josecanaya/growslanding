...
export const metadata: Metadata = {
  ...
  description:
    'Subí tu cronograma (Excel, Project o CSV) o creá las tareas con el asistente. Grows las ordena, arma bloques y te genera los mensajes de WhatsApp para tus contratistas. Gratis.',
};
