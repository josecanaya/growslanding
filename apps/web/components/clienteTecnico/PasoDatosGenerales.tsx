...
export function PasoDatosGenerales({ data, onChange, onNext }: PasoDatosGeneralesProps) {
  ...
  }, [data.cantidad_plantas, data.superficie_por_planta, data.superficie_total, onChange]);
  ...
  // Función para manejar selección de mapa (pendiente de implementar)
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Modal de Google Maps - simplificado por ahora */}
      {showMap && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <h3 className="text-lg font-semibold mb-4">Seleccionar Ubicación</h3>
            <p className="text-gray-600 mb-4">Funcionalidad de mapa pendiente de implementar. Puedes ingresar la dirección manualmente.</p>
            <button
