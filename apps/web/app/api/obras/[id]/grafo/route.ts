...
/**
 * GET /api/obras/[id]/grafo — lectura del proyecto-grafo (orquestador / UI vivo).
 */
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return NextResponse.json({ success: true, data: loaded.snapshot });
  } catch (e) {
    console.error('[GET /api/obras/[id]/grafo]', e);
