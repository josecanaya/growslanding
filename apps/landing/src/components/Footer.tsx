      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <Building2 className="h-8 w-8 text-acento" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#que-es" className="text-white/70 hover:text-acento transition-colors">
                  ¿Qué es?
                </a>
              </li>
              <li>
                <a href="#para-quien" className="text-white/70 hover:text-acento transition-colors">
                  ¿Para quién?
                </a>
              </li>
              <li>
                <a href="#caracteristicas" className="text-white/70 hover:text-acento transition-colors">
                  Características
                </a>
              </li>
              <li>
                <a href="#comenzar" className="text-white/70 hover:text-acento transition-colors">
                  Comenzar
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-white/20 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-white/60 hover:text-acento transition-colors text-sm">
